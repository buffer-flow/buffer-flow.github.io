...
export function PivacryPolicyText() {
  return (
    <>
      ...
      <li>
      <p><strong>Application</strong> refers to Link'em, the software program provided by the Company.</p>
      </li>
      <li>
      <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Link'em.</p>
      </li>
      <li>
      ...
      <ul>
      <li>By email: bufferflow.info@gmail.com</li>
      </ul>
    </>
  )
}
